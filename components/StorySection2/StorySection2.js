...
import sImg1 from '/public/images/story/5.jpg'
import sImg2 from '/public/images/story/6.jpg'
import sImg3 from '/public/images/story/7.jpg'
...
const StorySection2 = (props) => {
    return (
        <section className={`wpo-story-section-s3 section-padding ${props.stClass}`} id="story">
